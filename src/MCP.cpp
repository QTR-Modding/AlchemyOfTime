...
void __stdcall UI::RenderLoreBox() {
    ...
    if (ImGui::BeginTable("table_lorebox_section", 2, table_flags)) {
        ...
        ImGui::TableNextColumn();
        ImGui::TextColored(lorebox_show_title ? ImVec4(0, 1, 0, 1) : ImVec4(1, 0, 0, 1),
        ...
        ImGui::TableNextColumn();
        ImGui::TextColored(lorebox_show_percentage ? ImVec4(0, 1, 0, 1) : ImVec4(1, 0, 0, 1),
        ...
        ImGui::TableNextColumn();
        ImGui::TextColored(show_mod_name ? ImVec4(0, 1, 0, 1) : ImVec4(1, 0, 0, 1),
        ...
        ImGui::TableNextColumn();
        ImGui::TextColored(show_multiplier ? ImVec4(0, 1, 0, 1) : ImVec4(1, 0, 0, 1),
        ...
        auto colorEdit4RGB = [](const char* label, ImVec4& col) {
            ...
            if (ImGui::ColorEdit4(
                label, c,
                ImGuiColorEditFlags_NoInputs | ImGuiColorEditFlags_NoAlpha | ImGuiColorEditFlags_DisplayRGB)) {
                col.x = c[0];
                col.y = c[1];
                col.z = c[2];
            }
        ...
        ImGui::TableNextColumn();
        ImGui::Text("#%02X%02X%02X", static_cast<int>(col_title.x * 255), static_cast<int>(col_title.y * 255),
                    static_cast<int>(col_title.z * 255));
        ImGui::TableNextRow();
        ImGui::TableNextColumn();
        colorEdit4RGB("Neutral color", col_neutral);
        ImGui::TableNextColumn();
        ImGui::Text("#%02X%02X%02X", static_cast<int>(col_neutral.x * 255), static_cast<int>(col_neutral.y * 255),
                    static_cast<int>(col_neutral.z * 255));
        ImGui::TableNextRow();
        ImGui::TableNextColumn();
        colorEdit4RGB("Slow color", col_slow);
        ImGui::TableNextColumn();
        ImGui::Text("#%02X%02X%02X", static_cast<int>(col_slow.x * 255), static_cast<int>(col_slow.y * 255),
                    static_cast<int>(col_slow.z * 255));
        ImGui::TableNextRow();
        ImGui::TableNextColumn();
        colorEdit4RGB("Fast color", col_fast);
        ImGui::TableNextColumn();
        ImGui::Text("#%02X%02X%02X", static_cast<int>(col_fast.x * 255), static_cast<int>(col_fast.y * 255),
                    static_cast<int>(col_fast.z * 255));
        ImGui::TableNextRow();
        ImGui::TableNextColumn();
        colorEdit4RGB("Transform color", col_transform);
        ImGui::TableNextColumn();
        ImGui::Text("#%02X%02X%02X", static_cast<int>(col_transform.x * 255), static_cast<int>(col_transform.y * 255),
                    static_cast<int>(col_transform.z * 255));
        ImGui::TableNextRow();
        ImGui::TableNextColumn();
        colorEdit4RGB("Separator color", col_separator);
        ImGui::TableNextColumn();
        ImGui::Text("#%02X%02X%02X", static_cast<int>(col_separator.x * 255), static_cast<int>(col_separator.y * 255),
...
void __stdcall UI::RenderInspect() {
    ...
    is_list_box_focused = ImGui::IsItemHovered(ImGuiHoveredFlags_NoNavOverride) || ImGui::IsItemActive();
        ...
        if (selectedItem.contains(sub_item_current)) {
            ...
            if (ImGui::BeginTable("table_inspect", 8, table_flags)) {
                ...
                for (const auto& item : selectedInstances) {
                    ImGui::TableNextRow();
                    ImGui::TableNextColumn();
                    ImGui::TextUnformatted(std::format("{}/{} {}", item.stage_number.first, item.stage_number.second,
